...
public class nocturnal_pattern extends BaseActivity {
/**
 * 夜间模式*/
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_nocturnal_pattern);
//    }
    @Override
    protected void setActivityTitle() {
        initTitle();//初始化标题
        setTitle("夜间模式", this); /**使用的是BaseActivity的98行代码因此具有返回功能*/
